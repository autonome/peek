...
const defaults = {
  ...
  features: [
    { id: 'cee1225d-40ac-41e5-a34c-e2edba69d599',
      ...
      start_url: 'peek://cmd/background.html',
      enabled: false,
    ...
    { id: '82de735f-a4b7-4fe6-a458-ec29939ae00d',
      ...
      start_url: 'peek://groups/background.html',
      enabled: false,
    ...
    { id: 'ef3bd271-d408-421f-9338-47b615571e43',
      ...
      start_url: 'peek://peeks/background.html',
      enabled: false,
    ...
    { id: '30c25027-d367-4595-b37f-9db3de853c37',
      ...
      start_url: 'peek://scripts/background.html',
      enabled: false,
    ...
    { id: '434108f3-18a6-437a-b507-2f998f693bb2',
      ...
      start_url: 'peek://slides/background.html',
      enabled: false,

...
const Panel = Symbiont.resolve({
  ...
  set _frameLoadersSwapped(value) {
    ...
    console.log('swapping fls, frame: ', this._frame);
    //console.log('uri:', this._frame.currentURI.spec);
  ...
  get frame() this._frame,
  set frame(value) {
    console.log('set frame(): ', value);
    this._frame = value;
  },
  ...
  _onShow: function _onShow() {
    try {
      if (!this._inited) { // defer if not initialized yet
        ...
        console.log('_onShow(): frame', typeof this._frame);
        //console.log('_onShow(): ', this._frame.currentURI.spec);
        //this._frameLoadersSwapped.bind(this);
